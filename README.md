# Physics Mini App - Production

Educational physics application with unified material storage system.

## 🚀 Live Deployment

- **Frontend**: https://zh-physics-app.windsurf.build
- **Backend**: Railway (in progress)

## 🎯 Features

### 📚 Material Management
- **Unified Storage** - All materials stored in database (no localStorage)
- **Teacher Dashboard** - Create, edit, publish materials
- **Student Access** - View published materials
- **Cross-device Sync** - Materials sync automatically
